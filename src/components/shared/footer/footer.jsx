...
const Footer = () => {
  return (
    <footer className="bg-gray-100 text-sm pt-6">
      <div className="w-full max-w-screen-xl flex justify-center items-center mb-6">
        ...
        <div className="grid lg:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-4xl max-lg:max-w-2xl bg-white [box-shadow:0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
          <div>
            ...
            <p className="text-[15px] text-slate-600 mt-4 leading-relaxed">
              Have some big idea to develop our system? Then reach out we'd love
              to hear about your idea and improve our system.
            </p>
            <div className="mt-12">
          ...
          <form className="space-y-4">
            <input
              type="text"
              placeholder="Name"
              className="w-full text-slate-900 rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-0 "
            />
            <input
              type="email"
              placeholder="Email"
            ...
            <textarea
              placeholder="Message"
              rows="6"
              className="w-full text-slate-900 rounded-md px-4 border border-gray-300 text-sm pt-2.5 outline-0 "
            ></textarea>
            <button
              type="button"
              className="text-white bg-brand rounded-md text-sm font-medium px-4 py-2.5 w-full cursor-pointer border-0 mt-2"
            >
              Send message
            </button>
          </form>
      ...
      <div className="py-3 flex flex-col md:flex-row justify-between items-center bg-brand px-5 text-white">
        <p>
